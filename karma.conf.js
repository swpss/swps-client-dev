// Karma configuration
// Generated on Mon Jul 20 2015 21:12:41 GMT+0530 (IST)
...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'src/libs/ngstorage/ngStorage.js',
      'src/libs/angular-mocks/angular-mocks.js',
      'src/libs/angular-animate/angular-animate.js',
      'src/libs/angular-aria/angular-aria.js',
      'src/libs/angular-material/angular-material.js',
      'src/libs/datepicker/*.min.js',
